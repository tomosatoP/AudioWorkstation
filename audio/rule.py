...
def verify_rule():
    ...
    rules = dict()
    # NOTE: mute channel 0
    rules['NOTE: mute chan 0'] = {'type': FLUID_MIDI_ROUTER_RULE_TYPE.NOTE, 'chan': None, 'param1': None, 'param2': None}
    ...
    rules['NOTE: unmute chan 1-15'] = {'type': FLUID_MIDI_ROUTER_RULE_TYPE.NOTE, 'chan': None, 'param1': None, 'param2': None}
    rules['NOTE: unmute chan 1-15']['chan'] = {'min': 1, 'max': 15, 'mul':1.0, 'add':0}
    # CC: without change
    ...
    with open('rule.mute_chan_0.json', 'w') as fw:
